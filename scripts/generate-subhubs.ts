...
const SUBHUBS: SubHub[] = [
  ...
  },
  {
    ...
    toolSlugs: ['adcreative-ai', 'pencil-ai', 'persado', 'smartly-io', 'albert-ai', 'pattern89', 'motionapp', 'madgicx', 'revealbot'],
  ...
  },
  {
    ...
    toolSlugs: ['fortnox-ai', 'visma-ai', 'bokio-ai', 'dooer', 'speedledger-ai', 'klara-ai', 'accountingai', 'billogram-ai', 'wint-ai', 'pleo-ai'],
  ...
  },
  {
    ...
    toolSlugs: ['fortnox-redovisning', 'pw-ai', 'deloitte-ai', 'kpmg-ai', 'ey-ai', 'xero-ai', 'quickbooks-ai', 'accountingai-pro', 'reconcile-ai', 'taxdome-ai'],

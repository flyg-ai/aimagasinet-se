      ...
      <ol className="grid gap-4 sm:grid-cols-3">
        {top.map((a, i) => (
          <li key={a.slug}>
            <Link
              href={a.path}
              className="group flex items-start gap-4 rounded-lg border border-line bg-card p-4 transition-colors hover:border-line-strong"
            >
              <span
                aria-hidden
                className="shrink-0 font-mono text-3xl font-black leading-none text-rose-600 sm:text-4xl"
              >

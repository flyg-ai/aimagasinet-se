...
export const REVIEW_KNOWN: Record<string, Partial<ReviewProfile>> = {
  ...
  'canva-ai': {
    ...
    tags: ['Magic Media', 'Mallar', 'Bakgrundsborttagning', 'Team'],
    ...
    cons: ['Sämre bildkvalitet än verktyg som bara gör bilder', 'Hårt tak på Magic Media-krediter', 'Liten kontroll över stil och komposition'],
    offer: { title: 'Gratis att börja', price: 'Gratis · Pro 119 kr/mån', bestFor: 'Den som vill ha bild och layout på samma ställe' },
  ...
  'leonardo-ai': {
    ...
    company: 'Leonardo.Ai', model: 'Phoenix', founded: 2022, hq: 'Sydney, Australien',
    ...
    tags: ['Phoenix', 'Egna modeller', 'Canvas-editor', 'Daglig gratiskvot'],
    pros: ['Egna finetunade modeller ger en stil som håller ihop över många bilder', 'Daglig gratiskvot att arbeta i på riktigt', 'Canvas-editorn tar bilden vidare utan att byta verktyg'],
    cons: ['Fler rattar än en nybörjare behöver', 'Svagare på text i bilden', 'Kön kan bli lång på gratisnivån'],
    offer: { title: 'Gratis dagliga krediter', price: 'Gratis · Apprentice 10 USD/mån', bestFor: 'Spel- och konceptkonstnärer' },

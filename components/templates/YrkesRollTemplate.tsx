...
const SPEC_BY_SLUG: Record<string, YrkesRollSpec> = {
  ...
  designer: {
    ...
    topPicks: [
      { label: 'Grafisk design',  brand: 'Canva AI',      href: '/ai-verktyg/canva-ai' },
      { label: 'Grafisk design',  brand: 'Adobe Firefly', href: '/ai-verktyg/adobe-firefly' },
      { label: 'Logotyper',       brand: 'Looka',         href: '/ai-verktyg/looka-design' },
      { label: 'UI/UX',           brand: 'Figma AI',      href: '/ai-verktyg/figma-ai-ux' },
      { label: 'UI/UX',           brand: 'Galileo AI',    href: '/ai-verktyg/galileo-ai-ux' },
      { label: 'UI/UX',           brand: 'Uizard',        href: '/ai-verktyg/uizard-ux' },
      { label: 'Webbsidor',       brand: 'Framer AI',     href: '/ai-verktyg/framer-ai' },
      { label: 'Bildgenerering',  brand: 'Midjourney',    href: '/ai-verktyg/midjourney' },
      { label: 'Färgpaletter',    brand: 'Khroma',        href: '/ai-verktyg/khroma-design' },
  ...
  'fotograf-video': {
    ...
    topPicks: [
      { label: 'Bildredigering',       brand: 'Luminar Neo AI', href: '/ai-verktyg/luminar-neo-bredig' },
      { label: 'Upscale',              brand: 'Topaz Photo AI', href: '/ai-verktyg/topaz-photo-bredig' },
      { label: 'Bakgrundsborttagning', brand: 'Remove.bg',      href: '/ai-verktyg/removebg-bredig' },
      { label: 'Videoklippning',       brand: 'CapCut AI',      href: '/ai-video/capcut-ai-vklipp' },
      { label: 'Videoklippning',       brand: 'Canva Video',    href: '/ai-verktyg/canva-ai' },
      { label: 'Foto-AI',              brand: 'Adobe Firefly',  href: '/ai-verktyg/adobe-firefly' },
      ...
      { label: 'Podcast & ljud',       brand: 'Descript',       href: '/ai-verktyg/descript-ljud' },
      { label: 'Brusreducering',       brand: 'Krisp',          href: '/ai-verktyg/krisp' },
    ],
  },
  juridik: {
    subcategories: [

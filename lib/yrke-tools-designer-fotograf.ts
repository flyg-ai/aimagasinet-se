...
export const DESIGNER_FOTOGRAF_TOOLS: YrkeTool[] = [
  ...
  /* ── FOTOGRAF · Videoklippning ─────────────────────────────── */
  {
    ...
    pricing: 'Free huvudversion; Pro från 19,99 USD/mån för premium-effekter (priset varierar per region och plattform).',
    bestFor: 'Content-creators för TikTok, Reels och Shorts',
    offer: { title: 'Helt gratis', price: 'Gratis · Pro från 19,99 USD/mån' },

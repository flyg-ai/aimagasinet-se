...
export const YRKE_TOOLS: YrkeTool[] = [
  ...
  {
    slug: 'accountingai', parent: 'bokforing', brand: 'AccountingAI', company: 'AccountingAI', founded: 2020, hq: 'USA',
    score: 7.6, fallbackUrl: 'https://accountingai.com',
    title: 'AccountingAI — AI-driven bokföring för engelska marknaden',
    oneliner: 'Generisk AI-bokföring för engelskspråkiga marknader.',
    features: ['Auto-kategorisering av transaktioner', 'AI-genererade ekonomirapporter', 'Multi-currency-stöd', 'API för utvecklare'],
    pros: ['Stark API', 'Multi-currency-stöd', 'Modern stack'],
    cons: ['Inget svenskt-specifikt stöd', 'Mindre etablerat'],
    pricing: 'Starter 29 USD/mån, Growth 79 USD/mån, Scale 199 USD/mån.',
    bestFor: 'Internationella SaaS-företag',
    offer: { title: '14 dagar gratis trial', price: 'Starter 29 USD/mån' },
    tags: ['API', 'Multi-currency', 'Modern', 'Internationellt'],
    useCases: ['Internationell bokföring', 'Multi-currency-rapport', 'API-flöden', 'Auto-kategorisering', 'Finansiell modellering'],
    label: 'Bäst internationellt', logo: 'bg-zinc-700',
  },
  {
  ...
  {
    slug: 'accountingai-pro', parent: 'redovisning', brand: 'AccountingAI Pro', company: 'AccountingAI', founded: 2020, hq: 'USA',
    score: 7.5, fallbackUrl: 'https://accountingai.com',
    title: 'AccountingAI Pro — AI för internationell redovisning',
    oneliner: 'Pro-versionen av AccountingAI — för större internationella team.',
    features: ['Multi-entity konsolidering', 'AI-driven månadsrapporter', 'API med stark integration', 'Multi-currency och multi-region'],
    pros: ['Stark API', 'Multi-entity-stöd', 'Modern teknikstack'],
    cons: ['Inget svenskt-specifikt', 'Mindre etablerat'],
    pricing: 'Pro 199 USD/mån, Enterprise vid förfrågan.',
    bestFor: 'Internationella SaaS-företag med flera enheter',
    offer: { title: '14 dagar gratis trial', price: 'Pro 199 USD/mån' },
    tags: ['Multi-entity', 'API', 'Multi-currency', 'Modern'],
    useCases: ['Multi-entity konsolidering', 'Månadsrapporter', 'API-flöden', 'Multi-currency', 'Internationell controlling'],
    label: 'Bäst för multi-entity', logo: 'bg-purple-700',
  },
  {
    slug: 'reconcile-ai', parent: 'redovisning', brand: 'Reconcile AI', company: 'Reconcile', founded: 2021, hq: 'New York, USA',
    score: 7.8, fallbackUrl: 'https://reconcile.com',
    title: 'Reconcile AI — AI för automatisk avstämning',
    oneliner: 'AI-specialiserad på automatisk avstämning över system.',
    features: ['Cross-system avstämning automatiskt', 'Anomaly detection per konto', 'Audit trail för compliance', 'API-koppling till ERP-system'],
    pros: ['Smal men djup expertis', 'Stark cross-system-integration', 'God audit trail'],
    cons: ['Smalt fokus på avstämning', 'Inget brett bokföringsstöd'],
    pricing: 'Starter 199 USD/mån, Growth 499 USD/mån, Enterprise vid förfrågan.',
    bestFor: 'Controllers som drunknar i avstämningsarbete',
    offer: { title: 'Demo bokas via sajt', price: 'Starter 199 USD/mån' },
    tags: ['Avstämning', 'Anomaly', 'Cross-system', 'Audit'],
    useCases: ['Auto-avstämning', 'Anomaly detection', 'Cross-system-sync', 'Audit-trail', 'Månadsbokslut'],
    label: 'Bäst för avstämning', logo: 'bg-cyan-700',
  },
  {
